...
public class StereoCamera : MonoBehaviour
{
    ...
    void Awake()
    {
        Camera centerEyeCamera=this.gameObject.GetComponent<Camera>();
        centerEyeCamera.enabled=true;
        centerEyeCamera.cullingMask=0;
        if (!this.gameObject.GetComponent<ARCameraBackground>()){
            this.gameObject.AddComponent<ARCameraBackground>();
        }
        ...
        cameraLE.clearFlags=CameraClearFlags.Nothing;
        cameraLE.backgroundColor=new Color(0,0,0,0);
        cameraLE.depth=10;
        ...
        cameraRE.clearFlags=CameraClearFlags.Nothing;
        cameraRE.backgroundColor=new Color(0,0,0,0);
        cameraRE.depth=10;
